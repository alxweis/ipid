...
def run_os_scan(ips_tmp_file: str, targets_os_file: str):
    ...
    snmp_result_file = "targets/icmp/2025-09-22_15-53-10/snmp_os_info.csv.zst"  # run_scanner(executable, "snmp", snmp_ips_file)
    ssh_result_file = "targets/icmp/2025-09-22_15-53-10/ssh_os_info.csv.zst"  # run_scanner(executable, "ssh", ssh_ips_file)
    smb_result_file = "targets/icmp/2025-09-22_15-53-10/smb_os_info.csv.zst"  # run_scanner(executable, "smb", smb_ips_file)
    http_result_file = "targets/icmp/2025-09-22_15-53-10/http_os_info.csv.zst"  # run_http_scan(http_ips_file)
    dns_result_file = "targets/icmp/2025-09-22_15-53-10/dns_os_info.csv.zst"  # run_dns_scan(dns_ips_file)
