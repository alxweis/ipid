...
func Main() {
	...
	batchSize := 100 // TODO passe automatisch an CPU Auslastung an
	...
	for i := 0; i < len(targets); i += batchSize {
		...
		batchSize = batchSize + 200 //adjustBatchSize(cpuLoadData.AvgCPULoad, cpuLoadData.StdCPULoad, 0.8, 0, 15000, batchSize)
